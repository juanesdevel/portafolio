...
if(isset($_POST['submit'])){
    ...
    if (empty($errors)) {
        ...
        $sql = "UPDATE usuarios2 SET nombre_usuario=?, rol_usuario=?, codigo_usuario=?, contrasena_usuario=? WHERE id_usuario=?";
    ...
    $sql = "SELECT * FROM usuarios2 WHERE id_usuario=?";
    $stmt = $conexion->prepare($sql);
...
<body>
    <div class="container mt-5">
        ...
        <hr>
        <div class="container mt-5">
            <h2 style="color: #419cc7;">Editar Usuario</h2>
        </div>
        <hr>
