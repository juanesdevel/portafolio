...
-- Fecha de creación: 2025-04-11 05:20:16

-- Estructura de la tabla balance
CREATE TABLE `balance` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `movimiento` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `tipo_mov` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `valor` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `eventos` (
  ...
  `fecha` date NOT NULL,
  `nombre` varchar(35) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `descripcion` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `direccion` varchar(70) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

-- Datos de la tabla eventos
INSERT INTO eventos VALUES ('1', '2025-04-22', 'Evelin Gallego ', 'Cita ecografia Evelin para el día, Martes 22 abril 3pm - llevar orden, documento de identidad, historia clinica', 'Dentro de la clinica las vegas, la fase 2, consultorio 369 tercer piso');
INSERT INTO eventos VALUES ('2', '2025-05-05', 'Patricia Osorio', '05/05/2025 08:30:00-Control Medico de Apoyo Endocrinologia-Luz Angela - Llevar examenes de laboratorio.', 'Pendiente');
INSERT INTO eventos VALUES ('3', '2025-04-27', 'Patricia Osorio', 'Se debe realizar examenes de laboratorio para la cita del 5 de mayo.', 'Comfama San Antonio de Prado');
INSERT INTO eventos VALUES ('4', '2025-05-25', 'Patricia Osorio', 'Cumpleaños!', 'N/A');
INSERT INTO eventos VALUES ('5', '2025-06-12', 'Orley y Fredy', 'Cumpleaños!', 'N/A');
INSERT INTO eventos VALUES ('6', '2025-06-01', 'Estefany sobrina', 'Cumpleaños!', 'N/A');
INSERT INTO eventos VALUES ('7', '2025-02-12', 'Abuela Lucía', 'Cumpleaños!', 'N/A');
INSERT INTO eventos VALUES ('8', '2025-06-17', 'Juan Gallego', 'Vacaciones', 'N/A');

-- Estructura de la tabla mensualidades
CREATE TABLE `mensualidades` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `entidad` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `dia_obligacion` int(2) NOT NULL,
  `fecha_del_pago` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `valor_fijo` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `valor_pagado` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ref_contrato` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `link_pago` varchar(90) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `nota` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N/A',
  PRIMARY KEY (`id`)
...
CREATE TABLE `servicios` (
  `id` int(3) NOT NULL AUTO_INCREMENT,
  `entidad` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `propietario` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO servicios VALUES ('114', 'Github', 'Juan Esteban', 'juanesnet2016@gmail.com', 'Developer.2025', 'https://juanesdevel.github.io/net/');
INSERT INTO servicios VALUES ('115', 'Infinityfree', 'Juan Esteban', 'juanesnet2016@gmail.com', 'Developer.2026', 'https://dash.infinityfree.com/register');
INSERT INTO servicios VALUES ('116', 'Infinityfree', 'Juan Esteban', 'juanesnet2016@gmail.com', 'Developer2027', 'usuarios.kesug.com');
INSERT INTO servicios VALUES ('117', 'Infinityfree', 'Juan Esteban', 'juanesnet2016@gmail.com', '074sbSkxl1qMI', 'electrofact.kesug.com');
...
INSERT INTO servicios VALUES ('133', 'Sofia plus SENA', 'Juan', '1036611055', 'Juan.3008144841', '');
...
INSERT INTO servicios VALUES ('170', 'Sofia plus SENA', 'Patricia Osorio', '1128462346', '3195468662', '');
...
INSERT INTO servicios VALUES ('211', 'Ecar correo gmail', 'Juan Esteban', 'auxvalidaciones03@ecar.com.co', 'Juan.2025', '');
...
INSERT INTO servicios VALUES ('215', 'Grupo-exito', 'Patricia Osorio', 'posorio644@grupo-exito.com', 'Asesoracesde.2025', 'Red humana en la página de empleados del Éxito ');
...
-- Estructura de la tabla usuarios2
CREATE TABLE `usuarios2` (
  `id_usuario` int(11) NOT NULL AUTO_INCREMENT,
  `rol_usuario` varchar(10) CHARACTER SET utf8mb4 NOT NULL,
  `codigo_usuario` varchar(4) CHARACTER SET utf8mb4 NOT NULL,
  `nombre_usuario` varchar(40) CHARACTER SET utf8mb4 NOT NULL,
  `contrasena_usuario` varchar(70) CHARACTER SET utf8mb4 NOT NULL,
  PRIMARY KEY (`id_usuario`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- Datos de la tabla usuarios2
INSERT INTO usuarios2 VALUES ('1', 'admin', '0001', 'juan', '$2y$10$B7dDk2qtum2EITN7UDeAWOVQxgOeGmwWbTv6RMPb7KqSQntTlicma');
INSERT INTO usuarios2 VALUES ('4', 'admin', '0002', 'admin', '$2y$10$uSCJDVsnW0oyN2KyA5sJ4.HEu30FkfMnMlU1HHGb4Odz/5kgSVKpG');
