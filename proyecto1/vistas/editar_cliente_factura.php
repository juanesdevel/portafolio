...
<body>
    ...
    // consulta
        ...
        if($resultado){
            echo "<script> alert ('Los datos fueron actualizados en la base de datos correctamente'); location.assign ('controlador_factura.php'); </script>";
        } else {
            echo "<script> alert ('ERROR: Los datos no fueron actualizados en la base de datos'); location.assign ('controlador_factura.php'); </script>";
        }
    // Cerrar conexión
